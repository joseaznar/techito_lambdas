...
def CO2(recibo_luz, recibo_gas, numero_personas, horas_avion, horas_coche, tipo_alimentacion):
    ...
    if recibo_luz<800:
        ...
        excedente= precio-(150*.849+130*1.025) #los primeros dos precios que da CFE
        kwh_excedente=excedente/3.004 #3.004 es el precio que cobra CFE por el excedente
        kwh_anual=(150+130+kwh_excedente)*6 #150 y 130 son los kw que tienes que gastar para estar en los primeros niveles
    ...
    CO2_total = (CO2_luz + CO2_gas) / numero_personas + 285 + CO2_avion + CO2_coche + CO2_alimentacion*1000 #sumar 285 por la basura, 90 por cada hora de avion, litro y medio la hora (coche)
